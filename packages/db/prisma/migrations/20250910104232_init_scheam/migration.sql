...
-- AddForeignKey
ALTER TABLE "public"."Chat" ADD CONSTRAINT "Chat_roomdId_fkey" FOREIGN KEY ("roomdId") REFERENCES "public"."Room"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
